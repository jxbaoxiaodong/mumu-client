...
a = Analysis(
    ...
    hiddenimports=[
        ...
        'zhdate', 'imageio_ffmpeg', 'imageio_ffmpeg.binaries',
    ],
    hookspath=[], hooksconfig={}, runtime_hooks=[],
    excludes=['tkinter', 'matplotlib', 'numpy', 'pandas', 'scipy', 'pytest', 'IPython', 'notebook'],
...
exe = EXE(
    ...
    name='CZRZClient', debug=False, bootloader_ignore_signals=False,
